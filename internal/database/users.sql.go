...
RETURNING id, created_at, updated_at, email, hashed_password, is_chirpy_red_team
`
...
SELECT id, created_at, updated_at, email, hashed_password, is_chirpy_red_team FROM users
WHERE email = $1
`
